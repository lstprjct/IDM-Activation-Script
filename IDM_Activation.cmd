...
echo:          Create By Piash
echo:          _____________________________________________   
echo: 
echo:          Telegram: @piash_EEE
echo:          Github: https://github.com/lstprjct/IDM-Activation-Reset
echo:          _____________________________________________   
echo: 
echo:          [1] Activate IDM                                 
...
echo:
timeout /t 3
start https://github.com/lstprjct/IDM-Activation-Reset
exit /b
::========================================================================================================================================
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "Saqib"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v LName /t REG_SZ /d "Piash"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "saqibpiash@gmail.com"" & call :_rcont
