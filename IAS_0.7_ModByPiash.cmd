...
If not defined fname set fname=Ruzaini
If not defined lname set lname=Ourtech
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "ruzaini@ourtech.my"" & call :_rcont
